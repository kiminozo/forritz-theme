...
function shortcode_trans($atts, $content = null){
	...
	$str = '<div id="trans" class="tabbable">';
	$str .= '<ul class="nav trans-tabs">';
	$str .= '<li class="active"><a href="#tab-original" data-toggle="tab">'.__('Original','forritz').'</a></li>';
	$str .= '<li><a href="#tab-translation" data-toggle="tab">'.__('Translation','forritz').'</a></li></ul>';
	$str .= '<div class="tab-content">';	
	$str .= '<div class="tab-pane active" id="tab-original">'.$strs[0].'</div>';
	$str .= '<div class="tab-pane" id="tab-translation">'.$strs[1].'</div>';
	$str .= '</div></div>';
	return $str;
}
...
function shortcode_lrc($atts, $content = null){
	...
	$str = '<div id="lrc" class="tabbable">';	
	$str .= '<ul class="nav trans-tabs">';
	$str .= '<li class="active"><a href="#tab-original" data-toggle="tab">'.__('Original','forritz').'</a></li>';
	$str .= '<li><a href="#tab-translation" data-toggle="tab">'.__('Translation','forritz').'</a></li>';
	if(count($strs) == 3)
	{
		$str .= '<li><a href="#tab-romaji" data-toggle="tab">'.__('Romaji','forritz').'</a></li></ul>';
	}
	else
	{
		$str .= '</ul>';
	...
	if(count($strs) == 3)
	{
		$str .= '<div class="tab-pane" id="tab-romaji">'.$strs[2].'</div>';			
	}
	$str .= '</div></div>';
	return $str;
}
