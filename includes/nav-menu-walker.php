 ...
 * @return	array
 */
function the_bootstrap_nav_menu_css_class( $classes , $item ) {
	global $forritz_current_menu_title;
	if ( in_array('current-menu-item', $classes )
	OR in_array( 'current-menu-ancestor', $classes )) 
	{
		$classes[]	=	'active';
		return $classes;
	}
	if($item->title == $forritz_current_menu_title){
		$classes[]	=	'active';
		return $classes;
	}
...
add_filter( 'nav_menu_css_class', 'the_bootstrap_nav_menu_css_class', 10, 2);



/* Location: ./wp-content/themes/the-bootstrap/inc/nav-menu-walker.php */
function forritz_set_menu_discography(){
	global $forritz_current_menu_title;
	//TODO:
	$forritz_current_menu_title = __('Discography','forritz');
}
function forritz_set_menu_posts(){
	global $forritz_current_menu_title;
	//TODO:
	$forritz_current_menu_title = __('Posts','forritz');
}
